<template>
    ...
    <div>
        ...
        <table>
            ...
            <tbody>
                <tr v-for="account in accountList" v-bind:key="account.account" @click="moveDetail(account.account)">
...
export default {
    ...
    setup() {
        ...
        const accountList = computed(() => {
            ...
            return store.state.listAccount.accountList
        })
        ...
        onMounted(async () => {
            ...
            await store.dispatch('listAccount/fetchList')
        })
