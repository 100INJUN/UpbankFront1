    ...
    actions: {
        ...
        async fetchList({ state, commit }) {
            ...
            try {
                ...
                let response = await axios.get('http://localhost:8088/api/accountList', {}, {
                    headers: {
                ...
                // 콘솔 확인용
                console.log('state 확인: ', state.accountList)
